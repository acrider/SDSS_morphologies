...
b_img = make_mask_image(SDSS_r_img,90)
g_img = np.zeros_like(make_mask_image(SDSS_r_img,90))
r_img = make_mask_image(SDSS_r_img,90) / make_mask_image(SDSS_i_img,90)  
...
plt.figure(2)
py.clf()
py.imshow(make_mask_image(SDSS_i_img,90)[300:500,300:500], aspect='equal',interpolation='none',cmap='cubehelix')
...
plt.scatter(make_mask_image(radius_image,90), make_mask_image(SDSS_r_img,90) / make_mask_image(SDSS_i_img,90), s=0.1)
plt.show()
...
plt.imshow(r[300:500,300:500] / i[300:500,300:500], aspect='equal',interpolation='none', cmap='bwr')
plt.show