...
get_file = get_dir + '/frame-u-000745-3-0572.fits ' # Arp 220 Irregular
galaxy_RA  = 244.33086915786 # degrees DR10 Quick Look
galaxy_DEC = -0.0819928266897258 # degrees from DR10 Quick Look
galaxy_PetroRad = 5.6 # arcsec from DR10 Explore

get_file = get_dir + '/Haro_25/frame-'+ugriz_file+'-005112-4-0345.fits ' # Haro 25 BCD
galaxy_RA  = 162.1841958 # degrees DR10 Quick Look
galaxy_DEC = 26.0536472 # degrees from DR10 Quick Look
galaxy_PetroRad = 5.17 # arcsec from DR10 Explore

get_file = get_dir + '/Haro_29/frame-'+ugriz_file+'-003698-6-0176.fits ' # Haro 29 BCD
galaxy_RA  = 186.5663417 # degrees DR10 Quick Look
galaxy_DEC = 48.4935083 # degrees from DR10 Quick Look
galaxy_PetroRad = 15.0 # arcsec from DR10 Explore
...
hdulist.writeto(get_dir + '/galaxy_stamp_'+ugriz_file+'.fits',clobber=True)
